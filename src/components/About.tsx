                ...
                <div className="grid md:grid-cols-2 gap-16 items-start">
                    <div className="space-y-8 animate-fadeInUp delay-100">
                        ...
                        <div className="grid grid-cols-2 gap-6 pt-4">
                            <div className="glass-card p-6 rounded-xl hover:border-accent-cyan/50 transition-all duration-300 transform hover:-translate-y-1">
                            ...
                            <div className="glass-card p-6 rounded-xl hover:border-accent-blue/50 transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 animate-fadeInUp delay-300">
                        {[
                            {
                                Icon: Brush,
                                title: 'Clean UI',
